...
//O ? para garantir que não dê erro caso alguma das prioridades abaixo indefinida (undefined). O 'as strings' no final é para o TS lidar com o valor considerando que é uma string
const apiKey = Constants?.expoConfig?.extra?.apiKey as string;

// Configurando o axios para usar API TheMovieDB
